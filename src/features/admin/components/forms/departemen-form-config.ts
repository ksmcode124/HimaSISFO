...
export const createDepartemenFields: FormField[] = [
  ...
  { name: 'logo_departemen', label: 'UPLOAD LOGO', type: 'file', side: 'right', accept: 'image/*', maxSize: '1 MB' },
  { name: 'foto_departemen', label: 'UPLOAD FOTO', type: 'file', side: 'right', accept: 'image/*', maxSize: '1 MB' },
];
