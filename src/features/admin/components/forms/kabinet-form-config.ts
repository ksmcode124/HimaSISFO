...
export const cabinetCreateFields: FormField[] = [
  { name: 'namaKabinet', label: 'NAMA KABINET', type: 'text', required: true, side: 'left', placeholder: 'Nama Kabinet' },
  { name: 'tahun', label: 'TAHUN', type: 'text', required: true, side: 'left', placeholder: '2025/2026' },
  ...
  { name: 'logo', label: 'UPLOAD FOTO & LOGO', type: 'file', side: 'left', accept: 'image/*', maxSize: '10 MB' },
];
...
export const cabinetEditFields: FormField[] = [
  ...
  { name: 'misi', label: 'MISI', type: 'textarea', required: true, side: 'right', rows: 2 },
  { name: 'deskripsi', label: 'DESKRIPSI', type: 'textarea', rows: 3, side: 'right' },
  { name: 'logo', label: 'UPLOAD LOGO', type: 'file', side: 'left', accept: 'image/*', maxSize: '10 MB' },
