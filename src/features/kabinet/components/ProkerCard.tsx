...
export default function ProkerCard({
  ...
  return (
    <Card
      className={cn(
        "w-76 h-125 transition-all duration-700 ease-in-out border-none shadow-none bg-transparent p-0 gap-0 relative",
        isActive
          ? "z-20 md:scale-200 lg:scale-210"
          : "z-10 scale-44 md:scale-80 xl:scale-100",
      )}
    >
      <div
        className={cn(
