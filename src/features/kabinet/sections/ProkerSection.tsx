    ...
    <div className="relative w-full">
      <section className="relative w-full md:min-h-250 flex flex-col items-center py-24 overflow-hidden ">
        ...
        <div className="absolute -left-110 md:-left-100 top-1/2 -translate-y-1/2 w-150 h-125 md:w-200 md:h-150 z-0 opacity-40">
          <div className="w-full h-full rounded-full blur-[60px] md:blur-[120px] absolute" style={{backgroundColor: colorMap.bgOrnament}} />
        </div>
        ...
        <div className="relative flex flex-row items-center gap-4 mb-4 md:mb-10 md:mt-10 z-10">
          <h2 
            className="text-lg md:text-3xl -mt-10 md:mt-0 font-bold"
        ...
        {/* Carousel Proker */}
        <div className="top-10 relative w-full max-w-7xl h-62 md:h-138 flex items-center justify-center z-10">
          <div 
      ...
      <div className="absolute top-full w-[105%] z-10 left-1/2 -translate-x-1/2 -translate-y-3/6 md:-translate-y-2/3 h-100">
