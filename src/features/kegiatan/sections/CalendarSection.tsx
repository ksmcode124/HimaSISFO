...
function CalendarContent({ events }: { events: EventCardProps[] }) {
  return (
    <div className="relative flex flex-col gap-5">
      <h1 className="py-5 md:py-4 md:py-10 text-center font-semibold text-xl md:text-4xl xl:text-7xl text-[var(--color-dark-blue)]">
        Kalender
      </h1>
      <DynamicCalendar className="border-[#456882] border-6" events={events} />
      <div className="mx-2 md:mx-0 flex flex-col gap-[16px] p-5 border-2 border-[var(--color-dark-blue)] rounded-[10px] bg-white">
...
export async function CalendarSection() {
  ...
  return (
    <section className="relative p-0 m-0 top-0">
      ...
      <ContentLayer className="md:px-20 xl:px-60 pb-30">
