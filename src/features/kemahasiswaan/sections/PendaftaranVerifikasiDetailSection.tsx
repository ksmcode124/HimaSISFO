  ...
  return (
    <section className="grid grid-cols-12 min-h-[50vh] w-full justify-items-center place-items-center relative">
      <div className="relative col-span-12 lg:col-span-8 lg:col-start-3 xl:col-start-4 xl:col-span-6 w-full h-full flex items-center justify-center">
        <div className="
          absolute z-30 top-0 right-0 w-22.5 sm:w-36 md:w-52 lg:w-55 aspect-4/3 block
          -translate-x-[40%] translate-y-[90%]
          md:translate-x-[25%] md:translate-y-[5%]
          lg:-translate-y-[5%]
          xl:translate-x-[5%]
        ">
          <Image
        ...
        <div className="
          absolute left-0 bottom-0 rotate-15 w-35 sm:w-52 md:w-80 lg:w-60 aspect-4/3
          -translate-x-[5%] translate-y-[10%]
          md:translate-y-[25%] md:-translate-x-[10%]
          xl:translate-y-[35%] xl:-translate-x-[25%]
        ">
          <Image
        ...
        <FolderCard hasLayer title="Pendaftaran dan Verifikasi" heightClass="h-[70%] xl:h-[80%]">
          <h1 className="sticky top-0 bg-[#EDF3F6] text-sm sm:text-lg md:text-xl xl:text-3xl py-2 sm:py-4 xl:py-8 font-semibold text-center">
            {item.title}
          </h1>

          {/* Content scrollable */}
          <div className="overflow-y-auto max-h-[calc(70vh-6rem)] xl:max-h-[calc(60vh-6rem)] pb-5">
